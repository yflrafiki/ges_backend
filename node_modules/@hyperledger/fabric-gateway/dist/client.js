...
exports.deliverWithPrivateDataMethod = exports.deliverFilteredMethod = exports.deliverMethod = exports.chaincodeEventsMethod = exports.commitStatusMethod = exports.submitMethod = exports.endorseMethod = exports.evaluateMethod = void 0;
...
function newUnaryCallback(resolve, reject, wrap = (err) => err) {
    return (err, value) => {
        if (err) {
            reject(wrap((0, gatewayerror_1.newGatewayError)(err)));
            return;
        }
        if (value == null) {
