...
export class GetStateMultiple extends jspb.Message {
  clearKeysList(): void;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): GetStateMultiple.AsObject;
  static toObject(includeInstance: boolean, msg: GetStateMultiple): GetStateMultiple.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: GetStateMultiple, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): GetStateMultiple;
  static deserializeBinaryFromReader(message: GetStateMultiple, reader: jspb.BinaryReader): GetStateMultiple;
}

export namespace GetStateMultiple {
  export type AsObject = {
...
export class GetStateMultipleResult extends jspb.Message {
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): GetStateMultipleResult.AsObject;
  static toObject(includeInstance: boolean, msg: GetStateMultipleResult): GetStateMultipleResult.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: GetStateMultipleResult, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): GetStateMultipleResult;
  static deserializeBinaryFromReader(message: GetStateMultipleResult, reader: jspb.BinaryReader): GetStateMultipleResult;
}

export namespace GetStateMultipleResult {
  export type AsObject = {
...
export class WriteBatchState extends jspb.Message {
  clearRecList(): void;
  getRecList(): Array<WriteRecord>;
  setRecList(value: Array<WriteRecord>): void;
  addRec(value?: WriteRecord, index?: number): WriteRecord;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): WriteBatchState.AsObject;
  static toObject(includeInstance: boolean, msg: WriteBatchState): WriteBatchState.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: WriteBatchState, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): WriteBatchState;
  static deserializeBinaryFromReader(message: WriteBatchState, reader: jspb.BinaryReader): WriteBatchState;
}

export namespace WriteBatchState {
  export type AsObject = {
    recList: Array<WriteRecord.AsObject>,
  }
}
...
export class WriteRecord extends jspb.Message {
  ...
  getType(): WriteRecord.TypeMap[keyof WriteRecord.TypeMap];
  setType(value: WriteRecord.TypeMap[keyof WriteRecord.TypeMap]): void;
...
export namespace WriteRecord {
  export type AsObject = {
    ...
    collection: string,
    metadata?: StateMetadata.AsObject,
    type: WriteRecord.TypeMap[keyof WriteRecord.TypeMap],
  }
