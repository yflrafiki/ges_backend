...
goog.exportSymbol('proto.common.IdentifierHeader', null, global);
 ...
 * @constructor
 */
proto.common.IdentifierHeader = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.common.IdentifierHeader, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.common.IdentifierHeader.displayName = 'proto.common.IdentifierHeader';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
identifierHeader: msg.getIdentifierHeader_asB64()
  };
...
proto.common.MetadataSignature.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getIdentifierHeader_asU8();
  if (f.length > 0) {
    writer.writeBytes(
      3,
      f
...
/**
 * optional bytes identifier_header = 3;
 * @return {!(string|Uint8Array)}
 */
proto.common.MetadataSignature.prototype.getIdentifierHeader = function() {
...
/**
 * optional bytes identifier_header = 3;
 * This is a type-conversion wrapper around `getIdentifierHeader()`
 * @return {string}
 */
proto.common.MetadataSignature.prototype.getIdentifierHeader_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
      this.getIdentifierHeader()));
};
 ...
 * @return {!Uint8Array}
 */
proto.common.MetadataSignature.prototype.getIdentifierHeader_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getIdentifierHeader()));
};
 ...
 * @return {!proto.common.MetadataSignature} returns this
 */
proto.common.MetadataSignature.prototype.setIdentifierHeader = function(value) {
 ...
 * @return {!Object}
 */
proto.common.IdentifierHeader.prototype.toObject = function(opt_includeInstance) {
  return proto.common.IdentifierHeader.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.common.IdentifierHeader} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.common.IdentifierHeader.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.common.IdentifierHeader}
 */
proto.common.IdentifierHeader.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.common.IdentifierHeader;
  return proto.common.IdentifierHeader.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.common.IdentifierHeader} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.common.IdentifierHeader}
 */
proto.common.IdentifierHeader.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.common.IdentifierHeader.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.common.IdentifierHeader.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.common.IdentifierHeader} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.common.IdentifierHeader.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {number}
 */
proto.common.IdentifierHeader.prototype.getIdentifier = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.common.IdentifierHeader} returns this
 */
proto.common.IdentifierHeader.prototype.setIdentifier = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {!(string|Uint8Array)}
 */
proto.common.IdentifierHeader.prototype.getNonce = function() {
  return /** @type {!(string|Uint8Array)} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {string}
 */
proto.common.IdentifierHeader.prototype.getNonce_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
      this.getNonce()));
};
 ...
 * @return {!Uint8Array}
 */
proto.common.IdentifierHeader.prototype.getNonce_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getNonce()));
};
 ...
 * @return {!proto.common.IdentifierHeader} returns this
 */
proto.common.IdentifierHeader.prototype.setNonce = function(value) {
  return jspb.Message.setProto3BytesField(this, 2, value);
};
