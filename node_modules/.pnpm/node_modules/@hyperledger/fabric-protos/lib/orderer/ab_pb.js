...
goog.exportSymbol('proto.orderer.SeekInfo.SeekContentType', null, global);
...
proto.orderer.SeekInfo.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 4:
      ...
      break;
    case 5:
      var value = /** @type {!proto.orderer.SeekInfo.SeekContentType} */ (reader.readEnum());
 ...
 * @enum {number}
 */
proto.orderer.SeekInfo.SeekContentType = {
  BLOCK: 0,
  HEADER_WITH_SIG: 1
};
...
/**
 * optional SeekContentType content_type = 5;
 * @return {!proto.orderer.SeekInfo.SeekContentType}
 */
proto.orderer.SeekInfo.prototype.getContentType = function() {
  return /** @type {!proto.orderer.SeekInfo.SeekContentType} */ (jspb.Message.getFieldWithDefault(this, 5, 0));
};


/**
 * @param {!proto.orderer.SeekInfo.SeekContentType} value
 * @return {!proto.orderer.SeekInfo} returns this
 */
proto.orderer.SeekInfo.prototype.setContentType = function(value) {
