...
goog.exportSymbol('proto.common.Consenter', null, global);
...
goog.exportSymbol('proto.common.Orderers', null, global);
/**
 ...
 * @constructor
 */
proto.common.Consenter = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.common.Consenter, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.common.Consenter.displayName = 'proto.common.Consenter';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.common.Orderers = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.common.Orderers.repeatedFields_, null);
};
goog.inherits(proto.common.Orderers, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.common.Orderers.displayName = 'proto.common.Orderers';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.common.Consenter.prototype.toObject = function(opt_includeInstance) {
  return proto.common.Consenter.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.common.Consenter} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.common.Consenter.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.common.Consenter}
 */
proto.common.Consenter.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.common.Consenter;
  return proto.common.Consenter.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.common.Consenter} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.common.Consenter}
 */
proto.common.Consenter.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.common.Consenter.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.common.Consenter.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.common.Consenter} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.common.Consenter.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getId();
  if (f !== 0) {
    writer.writeUint32(
 ...
 * @return {number}
 */
proto.common.Consenter.prototype.getId = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.common.Consenter} returns this
 */
proto.common.Consenter.prototype.setId = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.common.Consenter.prototype.getHost = function() {
 ...
 * @return {!proto.common.Consenter} returns this
 */
proto.common.Consenter.prototype.setHost = function(value) {
 ...
 * @return {number}
 */
proto.common.Consenter.prototype.getPort = function() {
 ...
 * @return {!proto.common.Consenter} returns this
 */
proto.common.Consenter.prototype.setPort = function(value) {
 ...
 * @return {string}
 */
proto.common.Consenter.prototype.getMspId = function() {
 ...
 * @return {!proto.common.Consenter} returns this
 */
proto.common.Consenter.prototype.setMspId = function(value) {
 ...
 */
proto.common.Consenter.prototype.getIdentity = function() {
 ...
 * @return {string}
 */
proto.common.Consenter.prototype.getIdentity_asB64 = function() {
 ...
 * @return {!Uint8Array}
 */
proto.common.Consenter.prototype.getIdentity_asU8 = function() {
 ...
 * @return {!proto.common.Consenter} returns this
 */
proto.common.Consenter.prototype.setIdentity = function(value) {
  return jspb.Message.setProto3BytesField(this, 5, value);
};


/**
 * optional bytes client_tls_cert = 6;
 * @return {!(string|Uint8Array)}
 */
proto.common.Consenter.prototype.getClientTlsCert = function() {
 ...
 * @return {string}
 */
proto.common.Consenter.prototype.getClientTlsCert_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
 ...
 * @return {!Uint8Array}
 */
proto.common.Consenter.prototype.getClientTlsCert_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getClientTlsCert()));
};
 ...
 * @return {!proto.common.Consenter} returns this
 */
proto.common.Consenter.prototype.setClientTlsCert = function(value) {
  return jspb.Message.setProto3BytesField(this, 6, value);
};


/**
 * optional bytes server_tls_cert = 7;
 * @return {!(string|Uint8Array)}
 */
proto.common.Consenter.prototype.getServerTlsCert = function() {
 ...
 * @return {string}
 */
proto.common.Consenter.prototype.getServerTlsCert_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
 ...
 * @return {!Uint8Array}
 */
proto.common.Consenter.prototype.getServerTlsCert_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getServerTlsCert()));
};
 ...
 * @return {!proto.common.Consenter} returns this
 */
proto.common.Consenter.prototype.setServerTlsCert = function(value) {
 ...
 * @const
 */
proto.common.Orderers.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.common.Orderers.prototype.toObject = function(opt_includeInstance) {
  return proto.common.Orderers.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.common.Orderers} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.common.Orderers.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.common.Orderers}
 */
proto.common.Orderers.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.common.Orderers;
  return proto.common.Orderers.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.common.Orderers} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.common.Orderers}
 */
proto.common.Orderers.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new proto.common.Consenter;
      reader.readMessage(value,proto.common.Consenter.deserializeBinaryFromReader);
      msg.addConsenterMapping(value);
      break;
    default:
      reader.skipField();
      break;
 ...
 * @return {!Uint8Array}
 */
proto.common.Orderers.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.common.Orderers.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.common.Orderers} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.common.Orderers.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getConsenterMappingList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.common.Consenter.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!Array<!proto.common.Consenter>}
 */
proto.common.Orderers.prototype.getConsenterMappingList = function() {
  return /** @type{!Array<!proto.common.Consenter>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.common.Consenter, 1));
};


/**
 * @param {!Array<!proto.common.Consenter>} value
 * @return {!proto.common.Orderers} returns this
*/
proto.common.Orderers.prototype.setConsenterMappingList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};


/**
 * @param {!proto.common.Consenter=} opt_value
 * @param {number=} opt_index
 * @return {!proto.common.Consenter}
 */
proto.common.Orderers.prototype.addConsenterMapping = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.common.Consenter, opt_index);
};
 ...
 * @return {!proto.common.Orderers} returns this
 */
proto.common.Orderers.prototype.clearConsenterMappingList = function() {
  return this.setConsenterMappingList([]);
};
