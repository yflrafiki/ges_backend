...
export class ChaincodeSpec extends jspb.Message {
  getType(): ChaincodeSpec.TypeMap[keyof ChaincodeSpec.TypeMap];
  setType(value: ChaincodeSpec.TypeMap[keyof ChaincodeSpec.TypeMap]): void;
...
export namespace ChaincodeSpec {
  export type AsObject = {
    type: ChaincodeSpec.TypeMap[keyof ChaincodeSpec.TypeMap],
...
export class ChaincodeData extends jspb.Message {
  ...
  setPolicy(value?: common_policies_pb.SignaturePolicyEnvelope): void;
  ...
  setInstantiationPolicy(value?: common_policies_pb.SignaturePolicyEnvelope): void;
...
export class ChaincodeAdditionalParams extends jspb.Message {
  getUseWriteBatch(): boolean;
  setUseWriteBatch(value: boolean): void;

  getMaxSizeWriteBatch(): number;
  setMaxSizeWriteBatch(value: number): void;

  getUseGetMultipleKeys(): boolean;
  setUseGetMultipleKeys(value: boolean): void;

  getMaxSizeGetMultipleKeys(): number;
  setMaxSizeGetMultipleKeys(value: number): void;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): ChaincodeAdditionalParams.AsObject;
  static toObject(includeInstance: boolean, msg: ChaincodeAdditionalParams): ChaincodeAdditionalParams.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: ChaincodeAdditionalParams, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): ChaincodeAdditionalParams;
  static deserializeBinaryFromReader(message: ChaincodeAdditionalParams, reader: jspb.BinaryReader): ChaincodeAdditionalParams;
}

export namespace ChaincodeAdditionalParams {
  export type AsObject = {
    useWriteBatch: boolean,
    maxSizeWriteBatch: number,
    useGetMultipleKeys: boolean,
    maxSizeGetMultipleKeys: number,
  }
}
